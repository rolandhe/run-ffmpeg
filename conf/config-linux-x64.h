...
#define FFMPEG_CONFIGURATION "--enable-nonfree --enable-gpl --enable-libfdk-aac --enable-libx264 --enable-filter=delogo --enable-debug --disable-optimizations --enable-libopus --enable-shared --enable-pthreads --enable-version3 --enable-hardcoded-tables --host-cflags= --host-ldflags= --disable-x86asm --disable-stripping --enable-ffplay"
